...
function button(href: string, label: string, background: string): string {
  return `<a href="${href}" style="display:inline-block;padding:14px 24px;background:${background};color:${WHITE};font-family:${FONT_STACK};font-size:16px;font-weight:bold;text-decoration:none;border-radius:10px;">${escapeHtml(label)}</a>`;
}
...
function buildHtml(input: BookingEmailInput, preheader: string): string {
  ...
  rows.push(`
  <tr>
    <td style="padding:24px 28px;background:${NAVY_900};border-radius:12px 12px 0 0;">
  ...
  <tr>
    <td style="padding:28px 28px 8px;background:${WHITE};">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
          <td style="padding:14px 18px;background:${TRUST_50};border-left:4px solid ${TRUST_600};border-radius:8px;">
  ...
  rows.push(`
  <tr>
    <td style="padding:20px 28px 0;background:${WHITE};">
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:2px solid ${NAVY_900};border-radius:12px;">
        <tr>
          <td style="padding:22px 24px;">
            ...
            <p style="margin:2px 0 0;font-family:${FONT_STACK};font-size:26px;font-weight:bold;color:${NAVY_900};">
              ${escapeHtml(dayAndMonth)}
            </p>
            <p style="margin:10px 0 0;font-family:${FONT_STACK};font-size:22px;font-weight:bold;color:${FLAME_500};">
  ...
  <tr>
    <td style="padding:20px 28px 0;background:${WHITE};">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:${NAVY_50};border-radius:12px;">
        <tr>
  ...
  rows.push(`
  <tr>
    <td style="padding:24px 28px 0;background:${WHITE};">
      <p style="margin:0 0 10px;font-family:${FONT_STACK};font-size:17px;font-weight:bold;color:${NAVY_900};">
        What happens next
      </p>
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr><td style="padding:0 0 8px;font-family:${FONT_STACK};font-size:15px;line-height:22px;color:${NAVY_800};">1. Your appointment is now in our engineer&rsquo;s schedule.</td></tr>
        <tr><td style="padding:0 0 8px;font-family:${FONT_STACK};font-size:15px;line-height:22px;color:${NAVY_800};">2. Someone aged 18 or over needs to let the engineer in and give access to the boiler, the gas meter and every gas appliance being checked.</td></tr>
        <tr><td style="padding:0 0 8px;font-family:${FONT_STACK};font-size:15px;line-height:22px;color:${NAVY_800};">3. The appointment usually takes about ${cp12.durationMinutes} minutes.</td></tr>
  ...
  <tr>
    <td style="padding:24px 28px 0;background:${WHITE};">
      ...
      <p style="margin:0 0 16px;font-family:${FONT_STACK};font-size:15px;line-height:22px;color:${NAVY_800};">
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding:0 10px 10px 0;">${button(business.phoneHref, `Call ${business.phoneDisplay}`, NAVY_800)}</td>
          <td style="padding:0 0 10px;">${button(business.whatsappHref, "WhatsApp BSCJ", TRUST_600)}</td>
        </tr>
      </table>
      <p style="margin:6px 0 0;font-family:${FONT_STACK};font-size:14px;line-height:21px;color:${NAVY_600};">
  ...
  rows.push(`
  <tr>
    <td style="padding:28px;background:${WHITE};border-radius:0 0 12px 12px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-top:1px solid ${NAVY_100};">
        <tr>
          <td style="padding:18px 0 0;font-family:${FONT_STACK};font-size:12px;line-height:19px;color:${NAVY_600};">
